...
class DrawingController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        foreach ($classes as $classId) {
            ...
            // **Tambahkan BYE langsung ke babak berikutnya (tidak masuk pertandingan)**
            $newRoundParticipants = collect();

            for ($i = 0; $i < $byes; $i++) {
                $newRoundParticipants->push((object) [
            ...
            // **Mulai pertandingan ronde pertama**
            $round = 1;
            $currentRoundMatches = [];
            ...
            while ($participants->count() > 1) {
                ...
                // **Hindari BYE masuk ke pertandingan**
                ...
                // Simpan referensi peserta yang lolos ke babak berikutnya
                if (!$p2 || $p2->id === null) {
                    // Jika p1 mendapatkan BYE, dia langsung lolos
                    $newRoundParticipants->push($p1);
                } else {
                    // Jika pertandingan normal, pemenang akan ditentukan di babak berikutnya
